        ...
        <div class="px-4 py-5 sm:p-6">
            ...
            <div class="flex space-x-4">
                <a href="{{ route('user.investment') }}" 
                   class="inline-block bg-primary-500 hover:bg-primary-700 text-white font-semibold py-2 px-4 rounded-lg shadow-md transition duration-300">
                    New Investment
                </a>
                <a href="{{ route('user.withdrawal') }}"
                   class="inline-block bg-red-500 hover:bg-red-700 text-white font-semibold py-2 px-4 rounded-lg shadow-md transition duration-300">
                    Withdrawal
                </a>
            </div>
</div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div class="bg-green-50 p-6 rounded-lg">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-sm font-medium text-green-600">Total Investments</p>
                            <p class="text-2xl font-bold text-green-900">₹{{number_format($investment,2)}}</p>
                        </div>
                    </div>
                </div>
            </div>
