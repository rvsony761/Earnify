...
<div class="text-center py-20">
    ...
    <div class="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
        <div class="bg-white p-6 rounded-xl shadow hover:shadow-lg transition">
            <h3 class="text-lg font-semibold text-primary-600 mb-2">Earn ₹100/Referral and Bonus Also</h3>
        ...
        <div class="bg-white p-6 rounded-xl shadow hover:shadow-lg transition">
            ...
            <p class="text-gray-600 text-sm">Sign up and get started within minutes. Share your referral link instantly! and Bonus on each Investment.</p>
        </div>
        <div class="bg-white p-6 rounded-xl shadow hover:shadow-lg transition">
            <h3 class="text-lg font-semibold text-primary-600 mb-2">Secure & Transparent</h3>
            <p class="text-gray-600 text-sm">Your data is safe. Track your referrals and withdrawl yours earnings anytime.</p>
        </div>
    </div>
</div>
@endsection
